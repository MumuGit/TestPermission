...
public class SettingDialog {
    ...
    SettingDialog(@NonNull Context context, @NonNull SettingService settingService) {
        mBuilder = AlertDialog.newBuilder(context)
                .setCancelable(false)
                .setTitle(com.yanzhenjie.permission.R.string.permission_title_permission_failed)
                .setMessage(com.yanzhenjie.permission.R.string.permission_message_permission_failed)
                .setPositiveButton(com.yanzhenjie.permission.R.string.permission_setting, mClickListener)
